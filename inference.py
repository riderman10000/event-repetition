...
def main(model, event_class, event_user, file_path=None): 
    ...
    spikes = e2v.get_event_frames_vectorized_mod(
        events_tensor, width=128, height=128, visualize=1, decay=decay)
...
if __name__ == "__main__":
    # /home/rlwagun/Files/action_count_in_events3/all_code/time_series/artificial_data/individual/class2/user02_fluorescent_led-3.csv
    ...
    for file in files:
        ...
        main(model, event_class, event_user, file_path=file)
